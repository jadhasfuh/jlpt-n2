...
EXCEPCIONES = {
    ...
    ("義兄", "あに"), ("温", "ぬる"), ("昨夜", "ゆうべ"), ("日本人", "にほんじん"), ("一昨日", "おととい"), ("明後日", "あさって"), ("再来年", "さらいねん"),
    # topónimos: 神戸 no sale de juntar las lecturas de 神 y 戸
    ("神戸", "こうべ"), ("札幌", "さっぽろ"), ("三宮", "さんのみや"),
    ("花隈", "はなくま"), ("元町", "もとまち"), ("東京", "とうきょう"),
    ("西神中央", "せいしんちゅうおう"), ("二日分", "ふつかぶん"),
}
