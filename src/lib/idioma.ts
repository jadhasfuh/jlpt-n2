...
const T = {
  ...
  "cur.niveles":   { es: "Niveles", en: "Levels" },
  "cur.curso":     { es: "Curso",   en: "Course" },
  "cur.seccion":   { es: "Sección", en: "Section" },
  "cur.nivelSub":  { es: "{palabras} palabras · {unidades} unidades",
                     en: "{palabras} words · {unidades} units" },
  "cur.todoKanji": { es: "Todos los kanji del nivel", en: "All the kanji in this level" },
  "cur.todoKanjiSub": { es: "{n} kanji · lista y test", en: "{n} kanji · list and test" },
  "cur.todaGram":  { es: "Toda la gramática del nivel", en: "All the grammar in this level" },
  "cur.todaGramSub": { es: "{n} puntos, de simple a complejo",
                     en: "{n} points, from simple to complex" },
  "cur.seccionSub":{ es: "{palabras} palabras en {unidades} unidades · {kanji} kanji",
                     en: "{palabras} words in {unidades} units · {kanji} kanji" },
  "cur.masGram":   { es: " · {n} puntos de gramática", en: " · {n} grammar points" },
  "cur.unidadSub": { es: "{palabras} palabras · {kanji} kanji",
                     en: "{palabras} words · {kanji} kanji" },
  "cur.masGramCorto": { es: " · {n} de gramática", en: " · {n} grammar" },
  "cur.mejorTestTit": { es: "mejor test: {n}%", en: "best test: {n}%" },
  "cur.avanceNivel":{ es: " · {n} % hecho", en: " · {n} % done" },
  "cur.temaSub":    { es: "{palabras} palabras · {unidades} unidades",
                      en: "{palabras} words · {unidades} units" },
  "lec.aciertos":   { es: "Comprensión: {a} de {n}. Esta unidad ya cuenta como cubierta.",
                      en: "Comprehension: {a} of {n}. This unit now counts as covered." },
  "cur.kanjiNivel":{ es: "Los {n} kanji del nivel, de los más frecuentes a los más raros",
                     en: "The {n} kanji in this level, from the most common to the rarest" },
  "cur.kanjiSecc": { es: "Los {n} kanji que salen en esta sección",
                     en: "The {n} kanji that appear in this section" },
  "cur.gramNivel": { es: "Los {n} puntos del nivel, de los más simples a los más complejos",
                     en: "The {n} points in this level, from the simplest to the most complex" },
  "cur.gramSecc":  { es: "Los {n} puntos que aparecen en esta sección",
                     en: "The {n} points that appear in this section" },
  ...
  "ex.preguntas":   { es: "Preguntas", en: "Questions" },
  "ex.nPreguntas":  { es: "{n}", en: "{n}" },
  "ex.preguntasAyuda": { es: "Cuántas entran. La proporción entre tipos es la del examen real.",
                      en: "How many are included. The mix of question types matches the real exam." },
  "ex.reloj":       { es: "Reloj", en: "Timer" },
  "ex.conReloj":    { es: "Con tiempo", en: "Timed" },
  "ex.sinReloj":    { es: "Sin tiempo", en: "Untimed" },
  "ex.conRelojAyuda": { es: "Como en el examen real: si se acaba el tiempo, se acaba el examen.",
                      en: "Like the real exam: when time runs out, the exam ends." },
  "ex.sinRelojAyuda": { es: "Las mismas preguntas, sin cuenta atrás. Se ve el tiempo que llevas, pero nadie te corta.",
                      en: "The same questions, no countdown. You can see your elapsed time, but nothing cuts you off." },
  "ex.transcurrido":{ es: "sin reloj", en: "untimed" },
  ...
  // ----------------------------------------------------------- muro de pago
  "muro.tituloExamen":   { es: "Los mini exámenes van con la suscripción",
                           en: "Mini exams come with the subscription" },
  "muro.tituloContenido":{ es: "Esta parte va con la suscripción",
                           en: "This part comes with the subscription" },
  "muro.cuerpo":         { es: "La primera sección de cada nivel es libre y siempre lo será. El resto se abre al suscribirte, por 79 pesos al mes que puedes cancelar cuando quieras.",
                           en: "The first section of every level is free and always will be. The rest opens with a subscription — MX$79 a month, cancel whenever you like." },
  "muro.v1":             { es: "Los cinco niveles completos, del N5 al N1",
                           en: "All five levels, N5 through N1" },
  "muro.v2":             { es: "Mini exámenes con preguntas que van rotando",
                           en: "Mini exams with questions that rotate" },
  "muro.v3":             { es: "Tu progreso guardado y sincronizado entre aparatos",
                           en: "Your progress saved and synced across devices" },
  "muro.ver":            { es: "Ver la suscripción", en: "See the subscription" },
  "muro.seguirGratis":   { es: "Seguir con lo gratuito", en: "Keep using the free part" },
  "muro.pie":            { es: "Sin anuncios y sin rastreadores. Nunca.",
                           en: "No ads and no trackers. Ever." },

  "ex.hacefaltaCuenta": { es: "Los exámenes están en la suscripción.",
                          en: "Exams are part of the subscription." },
  "ex.verSuscripcion":  { es: "Ver la suscripción", en: "See the subscription" },
  ...
  "avi.titulo":     { es: "Avisos de repaso", en: "Review reminders" },
  "avi.que":        { es: "Un aviso al día, y sólo si tienes palabras esperando. Nada más.",
                      en: "One reminder a day, and only if you have words waiting. Nothing else." },
  "avi.activar":    { es: "Activar los avisos", en: "Turn reminders on" },
  "avi.quitar":     { es: "Quitar los avisos", en: "Turn reminders off" },
  "avi.hora":       { es: "a las", en: "at" },
  "avi.activo":     { es: "Te avisaremos a las {h} los días que tengas repaso.",
                      en: "We'll remind you at {h} on days you have reviews due." },
  "avi.denegado":   { es: "Este navegador tiene los avisos bloqueados para jlptest. Se vuelven a permitir desde el candado de la barra de direcciones, en «Notificaciones».",
                      en: "This browser has notifications blocked for jlptest. You can allow them again from the padlock in the address bar, under «Notifications»." },
  "avi.aparato":    { es: "Se guarda por aparato: el móvil y el ordenador se activan por separado.",
  ...
  "lib2.gramFuera": { es: "También aparece aquí, y se enseña en otro capítulo",
                      en: "Also used here, taught in another chapter" },
  "lib2.visto":     { es: "cap. {i}", en: "ch. {i}" },
  "lib2.deFuera":   { es: "También salen aquí, y se estudian en otro capítulo",
                      en: "Also in this chapter, studied elsewhere" },
  ...
  "lib2.leer":      { es: "Leer el libro", en: "Read the book" },
  "lib2.leerSub":   { es: "Las lecturas del nivel, seguidas y en orden: una historia con los mismos personajes.",
                      en: "The level's passages, read straight through in order: one story with the same characters." },
  "lec.porTandas":  { es: "Las lecturas usan sólo el vocabulario y la gramática que ya viste hasta aquí.",
                      en: "The passages use only the vocabulary and grammar you have seen up to this point." },
  "lec.deOido":     { es: "Contesta de oído; luego pulsa «Ver el texto» para comprobarlo.",
                      en: "Answer by ear, then tap «Show the text» to check." },
  ...
  "kan.puntos":     { es: "{a} de {n} puntos · medio por el significado, medio por la lectura",
                      en: "{a} of {n} points · half for the meaning, half for the reading" },
  ...
  "ord.titulo":     { es: "Ordena la frase · {i} de {n}",
                      en: "Put the sentence in order · {i} of {n}" },
  "ord.comprobar":  { es: "Comprobar", en: "Check" },
  ...
  // ------------------------------------------------------------- suscripción
  // --- test de prueba, abierto y sin cuenta -------------------------------
  "lib.gratis":     { es: "Gratis, sin cuenta", en: "Free, no account" },
  "lib.titulo":     { es: "Test de nivel {n}", en: "{n} level test" },
  "lib.entradilla": { es: "{c} preguntas de vocabulario, kanji, gramática y escucha de {n}, con la explicación de cada respuesta al terminar.",
                      en: "{c} {n} vocabulary, kanji, grammar and listening questions, with an explanation for every answer at the end." },
  "lib.b1":         { es: "{c} preguntas, entre diez y quince minutos.",
                      en: "{c} questions, ten to fifteen minutes." },
  "lib.b2":         { es: "Corrección al final, con el porqué de cada una.",
                      en: "Marked at the end, with the reasoning for each one." },
  "lib.b3":         { es: "No hace falta cuenta ni tarjeta.",
                      en: "No account and no card needed." },
  "lib.empezar":    { es: "Empezar el test", en: "Start the test" },
  "lib.sinCuenta":  { es: "No se guarda nada. Nadie te pide el correo.",
                      en: "Nothing is saved. Nobody asks for your email." },
  "lib.vacio":      { es: "El test no está disponible ahora mismo. Vuelve en un rato.",
                      en: "The test isn't available right now. Try again in a while." },
  "lib.escuchar":   { es: "Escuchar", en: "Play" },
  "lib.otraVez":    { es: "Escuchar otra vez", en: "Play again" },
  "lib.escuchaNota":{ es: "En el examen real suena una sola vez. Aquí puedes repetirlo.",
                      en: "In the real exam it plays once. Here you can repeat it." },
  "lib.atras":      { es: "Atrás", en: "Back" },
  "lib.siguiente":  { es: "Siguiente", en: "Next" },
  "lib.corregir":   { es: "Ver mi resultado", en: "See my result" },
  "lib.elige":      { es: "Elige una opción para seguir.", en: "Pick an option to continue." },
  "lib.tuResultado":{ es: "Tu resultado", en: "Your result" },
  "lib.deTantas":   { es: "{a} de {c} correctas", en: "{a} of {c} correct" },
  "lib.vasBien":    { es: "Vas bien. Con este resultado, el {n} está a tu alcance; lo que falta es sostener el repaso.",
                      en: "You're in good shape. At this level {n} is within reach; what's left is keeping the reviews going." },
  "lib.aunNo":      { es: "Todavía no llegas al corte del {n}, que está en el 60 %. Es normal: se sube practicando poco y a diario.",
                      en: "You're not at the {n} pass mark yet, which sits at 60%. That's normal — it comes up with short, daily practice." },
  "lib.invitacion": { es: "Esto es una muestra. Con la suscripción tienes los cinco niveles enteros, exámenes completos con lectura y escucha, y el repaso espaciado que decide qué toca cada día.",
                      en: "This is a sample. A subscription gets you all five levels, full exams with reading and listening, and spaced review that decides what you study each day." },
  "lib.verPlanes":  { es: "Ver los planes", en: "See the plans" },
  "lib.verNivel":   { es: "Ver el temario de {n}", en: "Browse the {n} syllabus" },
  "lib.correccion": { es: "La corrección", en: "The answers" },
  "lib.tuya":       { es: "— tu respuesta", en: "— your answer" },
  "lib.enlaceMuro": { es: "Probar el test gratuito de {n}", en: "Try the free {n} test" },
  "lib.tarjetaTit": { es: "¿No sabes por dónde empezar?", en: "Not sure where to start?" },
  "lib.tarjetaSub": { es: "Mide tu nivel con 25 preguntas. Gratis y sin cuenta.",
                      en: "Check your level with 25 questions. Free, no account." },
  "lib.tarjetaBtn": { es: "Hacer el test de {n}", en: "Take the {n} test" },
  "per.ayuda":      { es: "¿Algún problema con el cobro?", en: "Something wrong with a charge?" },
  "per.ayudaSub":   { es: "Escríbenos desde el mismo correo de tu cuenta y lo miramos. Los reembolsos de los primeros 14 días se hacen sin preguntar.",
                      en: "Write to us from the same address your account uses. Refunds within the first 14 days are given no questions asked." },
  "mar.titulo":     { es: "Marcador de {n}", en: "{n} leaderboard" },
  "mar.ultimos7":   { es: "Mejores notas de los últimos 7 días",
                      en: "Best scores in the last 7 days" },
  "mar.recientes":  { es: "Últimos en pasar", en: "Recently taken" },
  "mar.apuntate":   { es: "Deja tu marca", en: "Put your name up" },
  "mar.nombre":     { es: "Tu nombre", en: "Your name" },
  "mar.publico":    { es: "Se verá en esta página. No pongas datos personales ni tu correo.",
                      en: "This shows on this page. Don't put personal details or your email." },
  "mar.enviar":     { es: "Publicar mi nota", en: "Post my score" },
  "mar.enviando":   { es: "Publicando…", en: "Posting…" },
  "mar.hecho":      { es: "Listo, tu nota está guardada. El marcador se ve en la página del test en cuanto haya unas cuantas notas de esta semana.",
                      en: "Done, your score is saved. The leaderboard shows up on the test page once there are a few scores from this week." },
  "mar.fallo":      { es: "No se ha podido publicar. Inténtalo otra vez.",
                      en: "Couldn't post it. Try again." },
  "mar.saltar":     { es: "Sin publicar, gracias", en: "No thanks" },
  "mar.haceDias":   { es: "hace {n} d", en: "{n}d ago" },
  "mar.haceHoras":  { es: "hace {n} h", en: "{n}h ago" },
  "mar.ahora":      { es: "ahora mismo", en: "just now" },
  "lib.queEs":      { es: "Qué es el JLPT {n}", en: "What the JLPT {n} is" },
  "lib.sobreN5":    { es: "El N5 es el primer escalón del Examen de Aptitud de Japonés. Da por sabidos el hiragana y el katakana, unos cien kanji y el vocabulario y las estructuras del día a día: presentarse, comprar, preguntar la hora, hablar de lo que se hizo ayer. Este test cubre la parte de vocabulario, kanji y gramática, que es donde se ve enseguida si la base está o no está.",
                      en: "N5 is the first rung of the Japanese-Language Proficiency Test. It assumes hiragana and katakana, around a hundred kanji, and everyday vocabulary and structures: introducing yourself, shopping, asking the time, talking about yesterday. This test covers the vocabulary, kanji and grammar part, where a shaky foundation shows up fastest." },
  "lib.sobreN4":    { es: "El N4 es el segundo escalón del Examen de Aptitud de Japonés. Pide unos trescientos kanji y el japonés cotidiano hablado a velocidad normal: formas potenciales, condicionales, dar y recibir, y el paso del estilo cortés al llano. Este test cubre la parte de vocabulario, kanji y gramática.",
                      en: "N4 is the second rung of the Japanese-Language Proficiency Test. It expects around three hundred kanji and everyday Japanese spoken at normal speed: potential and conditional forms, giving and receiving, and the shift between polite and plain style. This test covers the vocabulary, kanji and grammar part." },
  ...
  "sus.veniasDe":   { es: "Esa sección va con la suscripción. La primera de cada nivel es libre y siempre lo será.",
                      en: "That section comes with the subscription. The first one in every level is free and always will be." },
  "sus.mensual":    { es: "Mensual", en: "Monthly" },
  "sus.anual":      { es: "Anual", en: "Annual" },
  "sus.ahorras":    { es: "Ahorras {n} %", en: "Save {n}%" },
  "sus.equivale":   { es: "Sale a {p} al mes, cobrado una vez al año.",
                      en: "Works out at {p} a month, billed once a year." },
  "sus.mismoTodo":  { es: "Los dos planes traen exactamente lo mismo. Sólo cambia cada cuánto se cobra.",
                      en: "Both plans include exactly the same. Only the billing period changes." },
  "sus.popular":    { es: "El que sale mejor", en: "Best value" },
  "sus.doceSueltos":{ es: "12 meses sueltos", en: "12 separate months" },
  "sus.unAno":      { es: "Un año", en: "One year" },
  "sus.tuAhorro":   { es: "Te quedas {p}", en: "You keep {p}" },
  "sus.cincoNiveles": { es: "Los cinco niveles, del primero al último",
                        en: "All five levels, first to last" },
  ...
  "app.tuCuenta":   { es: "Tu cuenta", en: "Your account" },
  "app.soloCuenta": { es: "Esta parte está disponible en las cuentas con acceso completo.",
                      en: "This part is available on accounts with full access." },
  "app.gestionFuera":{ es: "El estado de tu cuenta se consulta y se gestiona desde el navegador.",
                       en: "Your account status is viewed and managed from the browser." },
  "sus.libre":      { es: "Acceso permanente", en: "Permanent access" },
  "sus.libreTxt":   { es: "Esta cuenta tiene el acceso completo sin caducidad y sin ningún cobro asociado.",
                      en: "This account has full access with no expiry and no charge attached." },
  "sus.cortesia":   { es: "Cuenta de cortesía", en: "Complimentary account" },
  "sus.cortesiaTxt":{ es: "Alguien te ha regalado el acceso completo. No hay ningún cobro asociado a tu cuenta.",
                      en: "Someone has gifted you full access. There's no charge attached to your account." },
  "sus.cortesiaFin":{ es: "Vale hasta el {f}.", en: "Valid until {f}." },
