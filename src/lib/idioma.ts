...
const T = {
  ...
  "ex.verTranscripcion": { es: "Ver la transcripción", en: "Show the transcript" },
  "ex.transcripcion":    { es: "transcripción del audio", en: "audio transcript" },
  "ex.loQueDecide":      { es: "lo que decide la respuesta", en: "what settles the answer" },
  "com.parar":           { es: "Parar", en: "Stop" },
