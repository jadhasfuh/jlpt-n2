...
const T = {
  ...
  "sus.entraPrimero": { es: "Entra con tu correo para poder suscribirte.",
                        en: "Sign in with your email to subscribe." },
  "sus.aunNo":      { es: "El pago todavía no está abierto. Mientras tanto la app está entera y gratis.",
                      en: "Payments aren't open yet. In the meantime the whole app is free." },
