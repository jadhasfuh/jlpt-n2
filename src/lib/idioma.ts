...
const T = {
  ...
  "lib.entradilla": { es: "{c} preguntas de vocabulario, kanji y gramática de {n}, con la explicación de cada respuesta al terminar.",
                      en: "{c} {n} vocabulary, kanji and grammar questions, with an explanation for every answer at the end." },
